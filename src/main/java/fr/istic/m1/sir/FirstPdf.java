...
/**
 * PDF File generator class.
 *
 * @author aidasso, diaconu
 * @since 27/01/2020
 */
public class FirstPdf {
    ...
    private static Font catFont = new Font(Font.FontFamily.TIMES_ROMAN, LARGE_SIZE,
            Font.BOLD);
    private static Font redFont = new Font(Font.FontFamily.TIMES_ROMAN, NORMAL_SIZE,
            Font.NORMAL, BaseColor.RED);
    private static Font subFont = new Font(Font.FontFamily.TIMES_ROMAN, MEDIUM_SIZE,
            Font.BOLD);
    private static Font smallBold = new Font(Font.FontFamily.TIMES_ROMAN, NORMAL_SIZE,
            Font.BOLD);
     ...
     *
     * @param document, non-null document on which metadata are added
     */
    ...
    /**
     * Add title page on document
     *
     * @param document, document to receive the title
     * @throws DocumentException, if something wrong happens
     */
    ...
    private static void addEmptyLine(final Paragraph paragraph, int number) {
